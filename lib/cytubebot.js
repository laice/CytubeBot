...
discordClient.on('ready', () => {
    ...
    console.log('client', JSON.stringify(discordClient.channels));
...
CytubeBot.prototype.handleChangeMedia = function(data) {
    ...
    if(discordConnected) {
        ...
        let channel = discordClient.channels["goon.pub"].defaultChannel;
        discordClient.sendMessage(channel, `Now playing ${this.currentMedia["title"]} in https://goon.pub`);
    }
};
