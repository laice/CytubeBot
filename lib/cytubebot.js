					...
					case 'pubg':
						pubgStats(this.discordConfig.pubgKey, ctnt.join(","), (stats) => {
							...
							matchStats(this.discordConfig.pubgKey, lastMatch.id, id, (match) => {
								...
								let st = match.attributes.stats;
								msg.reply(`Last match stats for ${st.name}
														Kill Place: ${st.killPlace}
														Win Place: ${st.winPlace}
														Kills: ${st.kills}
														Assists: ${st.assists}
														Headshots: ${st.headshotKills}
														Revives: ${st.revives}
														Road Kills: ${st.roadKills}
														Team Kills: ${st.teamKills}
														Vehicles Destroyed: ${st.vehicleDestroys}																											
														Kill Streaks: ${st.killStreaks}
														Last Kill Points: ${st.lastKillPoints}
														Kill Points: ${st.killPoints}
														Last Win Points: ${st.lastWinPoints}
														Win Points: ${st.winPoints}
														Longest Kill: ${st.longestKill}
														Most Damage: ${st.mostDamage}
														Death Type: ${st.deathType}
														Time Survived: ${st.timeSurvived}
														Walk Distance: ${st.walkDistance}
														Swim Distance: ${st.swimDistance}
														Ride Distance: ${st.rideDistance}
														Weapons Aquired: ${st.weaponsAcquired}											
