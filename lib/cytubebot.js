					...
					case 'pubg':
						pubgStats(this.discordConfig.pubgKey, ctnt.join(","), (stats) => {
							...
							matchStats(this.discordConfig.pubgKey, lastMatch.id, id, (match) => {
								...
								let stats = match.attributes.stats;
								msg.reply(`Last match stats for ${stats.name}
														Kill Place: ${stats.killPlace}
														Win Place: ${stats.winPlace}
														Kills: ${stats.kills}
														...
														Vehicles Destroyed: ${stats.vehicleDestroys}																											
														Kill Streaks: ${stats.killStreaks}
														Last Kill Points: ${stats.lastKillPoints}
														Kill Points: ${stats.killPoints}
														Last Win Points: ${stats.lastWinPoints}
														Win Points: ${stats.winPoints}
														Longest Kill: ${stats.longestKill}
														Most Damage: ${stats.mostDamage}
														Death Type: ${stats.deathType}
														Time Survived: ${stats.timeSurvived}
														Walk Distance: ${stats.walkDistance}
														Swim Distance: ${stats.swimDistance}
														Ride Distance: ${stats.rideDistance}
														Weapons Aquired: ${stats.weaponsAcquired}											
